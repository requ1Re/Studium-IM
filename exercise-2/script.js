...
let sections = [
  ...
  },
  {
    ...
    title: "Hypertext",
    description: "Hypertext ist ein Text mit einer netzförmigen, dynamischen Struktur, in der die gewohnte Ordnung (lineare Sequenzialität) statischer gedruckter Publikationen technisch aufgebrochen wird. (<a href='https://de.wikipedia.org/wiki/Hypertext'>Quelle: Wikipedia</a>)",
  },
  {
    start: 94,
    end: 182,
  ...
  },
  {
    ...
    title: "URL",
    description: "Ein Uniform Resource Locator (Abk. URL; englisch für „einheitlicher Verorter für Ressourcen“) identifiziert und lokalisiert eine Ressource, beispielsweise eine Webseite, über die zu verwendende Zugriffsmethode (zum Beispiel das verwendete Netzwerkprotokoll wie HTTP oder FTP) und den Ort (englisch location) der Ressource in Computernetzwerken. (<a href='https://de.wikipedia.org/wiki/Uniform_Resource_Locator'>Quelle: Wikipedia</a>)",
  },
  {
    start: 257,
    end: 356,
    title: "DNS",
    description: "Das Domain Name System (DNS) ist ein hierarchisch unterteiltes Bezeichnungssystem in einem meist IP-basierten Netz zur Beantwortung von Anfragen zu Domain-Namen (Namensauflösung). (<a href='https://de.wikipedia.org/wiki/Domain_Name_System'>Quelle: Wikipedia</a>)",
  },
  {
    start: 356,
    end: 480,
    title: "Webbrowser",
    description: "Webbrowser oder allgemein auch Browser sind Computerprogramme zur Darstellung von Webseiten im World Wide Web oder allgemein von Dokumenten und Daten. (<a href='https://de.wikipedia.org/wiki/Webbrowser'>Quelle: Wikipedia</a>)",
  },
...
videoElement.addEventListener("timeupdate", () => {
  ...
  sections.forEach((section) => {
    if (currentTime >= section.start && currentTime < section.end) {
      if (
        !document
          .getElementById(`section-${section.start}`)
